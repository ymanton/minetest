...
if(GETTEXTLIB_FOUND)
	...
	set(GETTEXT_PO_PATH ${PROJECT_SOURCE_DIR}/po)
	...
	if(RUN_IN_PLACE AND NOT CMAKE_CROSSCOMPILING)
		set(GETTEXT_MO_BUILD_PATH ${PROJECT_SOURCE_DIR}/locale/<locale>/LC_MESSAGES)
	else()
		set(GETTEXT_MO_BUILD_PATH ${PROJECT_BINARY_DIR}/locale/<locale>/LC_MESSAGES)
	endif()
